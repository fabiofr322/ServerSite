...
-- Este projeto ja possui a funcao public.is_admin(uuid), usada por outras
-- politicas de RLS. Nao recriamos nem removemos essa funcao aqui para evitar
-- derrubar politicas existentes de storage, temporadas, fotos e comentarios.
...
alter table public.site_products
add column if not exists kit_images jsonb not null default '[]'::jsonb;
...
insert into public.site_products (
  type, name, slug, price, price_text, duration_text, tier, theme, image_url, kit_image_url, kit_images,
...
(
  ...
  'https://mc-heads.net/body/Steve/220', null, '[]'::jsonb,
...
(
  ...
  'https://mc-heads.net/body/fabiofr32/220', null, '[]'::jsonb,
  ...
  jsonb_build_array('Set completo de Diamante com Protecao III e Inquebravel III.', 'Espada de Diamante com Afiacao IV e Saque II.', 'Ferramentas de Diamante para iniciar a temporada.', '2 Totens da Imortalidade.', '16 Macas Douradas.', '1 Shulker Box e bolo especial.'),
...
(
  'vip', 'VIP Cerejeira', 'cerejeira', 29.90, 'R$ 29,90', '30 dias', 'VIP+', 'cerejeira',
  'https://mc-heads.net/body/KellCerejinha/220', 'Images/vips/vip-cerejeira-kit.png', jsonb_build_array('Images/vips/vip-cerejeira-kit.png'),
  ...
  jsonb_build_array('Set completo de Netherite com Protecao IV e Inquebravel III.', 'Espada de Netherite com Afiacao V e Saque III.', '4 Totens da Imortalidade.', '32 Macas Douradas e 64 Cenouras Douradas.', '1 Shulker Box.'),
...
(
  ...
  'https://mc-heads.net/body/vNeoo/220', null, '[]'::jsonb,
  ...
  jsonb_build_array('Set completo de Netherite com Protecao IV, Inquebravel III e Remendo.', 'Espada de Netherite com Afiacao V, Saque III, Aspecto Flamejante II e Remendo.', 'Ferramentas Netherite com Eficiencia V, Inquebravel III e Remendo.', '8 Totens da Imortalidade.', '64 Macas e 192 Cenouras Douradas.', 'Diamantes, ferros, perolas, ender chests, shulker e bolo.'),
...
on conflict (slug) do update set
  ...
  kit_image_url = excluded.kit_image_url,
